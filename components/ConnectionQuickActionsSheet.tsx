...
function ActionButton({
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.85}
      className="w-full rounded-2xl bg-white dark:bg-card-dark border border-slate-100 dark:border-slate-800 px-4 py-4 flex-row items-center"
    >
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <Pressable className="flex-1 bg-black/30 justify-end" onPress={onClose}>
        <Pressable
          className="bg-background-light dark:bg-background-dark rounded-t-[32px] px-6 pt-6 pb-10"
        ...
        >
          ...
          <View className="mt-6">
            ...
            <View className="flex-row gap-2">
              <TouchableOpacity
                onPress={() => onSnooze(1)}
                className="flex-1 rounded-full border border-slate-200 dark:border-slate-700 px-3 py-2.5 items-center"
              >
